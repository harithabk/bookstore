...
//echo "total".$total;
 ...
 $stmt = $conn->prepare("INSERT INTO tblcart(cartid,bid,uid,book_name,image,quantity,price,total) VALUES (NULL, :bid,:uid,:book_name,:image,:quantity,:price,:total)");
			...
			if($result>0){
				...
				//window.location.href="http://localhost/BookStore/index2.php";
				//exit;
			}else{
...
<script>
	window.location="http://localhost/BookStore/index2.php";
</script>
<meta http-equiv="refresh" content="0.0;url=http://localhost/BookStore/index2.php">
</head>
